...
Außerdem befindet sich dort der reale Querschnitt $Q_{real}$ %Formel fehlt
...
Damit lassen sich die Suszeptibilitäten $\chi_U$ nach Formel %xi_u
und $\chi_R$ nach Formel %xi_r
bestimmen.
...
Dazu werden einige atomare Daten der Stoffe wie die Quantenzahlen und die molare Masse M in Tabelle (\ref{tab:th1}) gesammelt, aus denen sich der Landé-Faktor $g_J$ nach Formel %landé
berechnen lässt.
Mit den gesammelten Daten lassen sich die theoretischen Suszeptibilitäten $\chi_T$ nach Formel mit $N$ nach bestimmen. %chi_T N
