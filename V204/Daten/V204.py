...
A2 = ds(A22)
print(f'Die mittlere Amplitude von T2 beträgt A2 = {A2} ')
...
print(f'Die mittleren Wärmeleitfähigkeit beträgt k = {kappa(8400, 377, 0.029, ds(t_ph), A1, A2) } (Messing dick) ' )

#Aluminium
#Berechnung von der Amplitude T5
x5, _ = find_peaks(T_5_2, distance = 15)
x5 = betrag(x5)
x6, _ = find_peaks(-T_5_2, distance = 15)
x6 = betrag(x6)
A55 = x5 - x6
A55 = betrag(A55)
A5 = ds(A55)
...
x5, _ = find_peaks(T_6_2, distance = 15)
x5 = betrag(x5)
x6, _ = find_peaks(-T_6_2, distance = 15)
x6 = betrag(x6)
A66 = - x5[0:-1] + x6
A66 = betrag(A66)
A6 = ds(A66)
...
x5, _ = find_peaks(T_7_3, distance = 15)
x5 = betrag(x5)
x6, _ = find_peaks(-T_7_3, distance = 15)
x6 = betrag(x6)
A77 = - x5[0:-1] + x6
A77 = betrag(A77)
...
#Berechnung von der Amplitude T6
x5, _ = find_peaks(T_8_3, distance = 15)
x5 = betrag(x5)
x6, _ = find_peaks(-T_8_3, distance = 15)
x6 = betrag(x6)
A88 =  x5 - x6
A88 = betrag(A88)
...
t_ph = - T_8_3[A88][0:-2] + T_7_3[A77]
print(f'Die Phasendifferenz beträgt t = {t_ph}')
print(f'Die durschnittliche Phasendifferenz beträgt t = {ds(t_ph)}')

#Berechnung der Wärmeleitfähigkeit

print(f'Die Anzahl an ermittelten Perioden ist {len(A77)} Wärmeleitfähigkeit beträgt k = {kappa(8000, 4182, 0.031, ds(t_ph), A77, A88[0:-2]) } (Edelstahl) ' )