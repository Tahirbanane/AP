...
\noindent
Der Brechungsindex von Luft kann nach Gleichung (\ref{eqn:nb2}) berechnet werden.
Es gilt:
...
\noindent
Die aufgenommenen Messwerte und die daraus nach (\ref{eqn:nb2}) berechneten Brechungsindizes von Luft sind in Tabelle (\ref{tab:n}) aufgeführt.
